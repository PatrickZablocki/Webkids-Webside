  ...
  return (
    <div className={styles.page}>
      ...
      <p>
        ...
        Datenschutzinformation informieren wir Sie über die wichtigsten Aspekte
      ...
      <p>
        ...
        wie Name, Anschrift und Zahlungsmittel des Käufers.
      </p>
      <p>
        Darüber hinaus werden zum Zweck der Vertragsabwicklung folgende Daten
        auch bei uns gespeichert: [Bitte Daten einfügen]. Die von Ihnen bereit
        ...
        Vertrag mit Ihnen nicht abschließen. Eine Datenübermittlung an Dritte
        erfolgt nicht, mit Ausnahme der Übermittlung der Kreditkartendaten an
      ...
      <p>
        Nach Abbruch des Einkaufsvorganges werden die bei uns gespeicherten
        Daten gelöscht. Im Falle eines Vertragsabschlusses werden sämtliche
        Daten aus dem Vertragsverhältnis bis zum Ablauf der steuerrechtlichen
        Aufbewahrungsfrist (7 Jahre) gespeichert.
      </p>
      <p>
        Die Daten Name, Anschrift, gekaufte Waren und Kaufdatum werden darüber
      ...
      <h2>Web-Analyse</h2>
      <p>
        Unsere Website verwendet Funktionen des Webanalysedienstes [Name des
        Dienstes] der Firma [Firmensitz inkl. Land]. Dazu werden Cookies
      ...
      <p>
        Sie können dies verhindern, indem Sie Ihren Browser so einrichten, dass
      ...
      <p>
        Die Beziehung zum Webanalyseanbieter basiert auf den
        Standardvertragsklauseln/einem Angemessenheitsbeschluss der Europäischen
        Kommission [bei Drittlandübermittlung].
      </p>
      <p>
      ...
      <p>
        ...
        Aufsichtsbehörde beschweren. In Deutschland ist dies die
        Datenschutzbehörde.
      </p>
